...
assert.equal(preload.includes("listProviders"), true);
assert.equal(preload.includes(IPC_CHANNELS.providerList), true);
...
assert.equal(consoleJs.includes("/workspace"), true);
...
assert.equal(mainProcess.includes("IPC_CHANNELS.providerList"), true);
