...

{
  ...
  assert.match(electronMain, /console_chat_branch_fork/);
  assert.match(electronMain, /console_chat_branch_rewind/);
  assert.match(electronMain, /console_chat_branch_edit/);
