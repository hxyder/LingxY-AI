...
for (const tool of [
  ...
  "COPY_TO_CLIPBOARD_TOOL", "READ_CLIPBOARD_TOOL", "NOTIFY_TOOL",
  "COMPOSE_EMAIL_TOOL", "SEND_EMAIL_SMTP_TOOL",
  ...
  "WRITE_FILE_TOOL", "EDIT_FILE_TOOL", "RUN_SCRIPT_TOOL",
  "GENERATE_DOCUMENT_TOOL", "RENDER_DIAGRAM_TOOL", "RENDER_SVG_TOOL"
]) {
