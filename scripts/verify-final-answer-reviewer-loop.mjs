...
assert.match(reviewer, /Reviewer note:/u, "reviewer loop must surface visible notes instead of silently rewriting");
...
assert.match(tests, /visible trace note instead of silently rewriting/u, "behavior tests must prove no silent rewrite");
