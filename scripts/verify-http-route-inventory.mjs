...
const expectedSummary = {
  ...
  "config-provider-routes.mjs": { methods: ["DELETE", "GET", "PATCH", "POST"], literalCount: 38, regexCount: 4 },
  "connector-routes.mjs": { methods: ["DELETE", "GET", "PATCH", "POST"], literalCount: 7, regexCount: 15 },
