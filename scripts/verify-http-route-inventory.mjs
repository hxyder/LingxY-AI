...
const expectedSummary = {
  ...
  "mcp-install-routes.mjs": { methods: ["GET", "POST"], literalCount: 4, regexCount: 0 },
  "note-project-conversation-routes.mjs": { methods: ["DELETE", "GET", "PATCH", "POST"], literalCount: 8, regexCount: 12 },
