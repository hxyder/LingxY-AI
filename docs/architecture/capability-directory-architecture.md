...
Status: inventory verified against the current repository on 2026-05-11 after CAP-5C desktop launch migration.
...
| Capability-owned tools | `src/service/capabilities/tools/` | `browser-web-tools.mjs`, `desktop-capture-gui-tools.mjs`, `desktop-launch-tools.mjs`, `document-renderer.mjs`, `email-tools.mjs`, `file-read-tools.mjs`, `memory-tools.mjs`, `mermaid-assets.mjs`, `os-app-tools.mjs`, `scheduler-tools.mjs`, `skill-install-tools.mjs`, `svg-sanitize.mjs`, `vision-analyze.mjs` |
