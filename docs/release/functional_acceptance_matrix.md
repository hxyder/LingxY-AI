...
| Browser entry | Browser extension, page source extraction, floating chip rules, and page-to-task handoff keep working | `verify:browser-extension`, `verify:browser-overlay`, `verify:page-source-extractor`, `verify:page-explain-handoff`, `verify:extension-enrichment` |
