...
export const IPC_CHANNELS = Object.freeze({
  ...
  shellCaptureWindowScreenshot: "uca:capture-window-screenshot",
  ...
  shellOpenUrl: "uca:shell-open-url",
  ...
  mcpServerTest: "uca:mcp-server-test",
  ...
  runtimeLabsConfigUpdate: "uca:runtime-labs-config-update",
  ...
  officeAddinsSetupStatus: "uca:office-addins-setup-status",
  browserExtensionSetup: "uca:browser-extension-setup",
  browserExtensionSetupStatus: "uca:browser-extension-setup-status",
