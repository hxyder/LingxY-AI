...
import { tryHandleBrowserExtensionSetupRoute } from "./http-routes/browser-extension-setup-routes.mjs";
...
import { tryHandleSearchRoute } from "./http-routes/search-routes.mjs";
...
export function createServiceHttpServer({ runtime, paths, port = 0, host = "127.0.0.1" }) {
  ...
  const routeGroups = [
    ...
    {
      name: "browser-extension-setup",
      handle: tryHandleBrowserExtensionSetupRoute
    },
    {
