...
export async function submitImageTask({
  ...
  const incomingSelectionMetadata = selectionMetadata && typeof selectionMetadata === "object"
    ? selectionMetadata
    : {};
  rawContextPacket.selection_metadata = {
    ...(rawContextPacket.selection_metadata ?? {}),
    ...incomingSelectionMetadata,
    content_evidence: mergeContentEvidence(
      rawContextPacket.selection_metadata?.content_evidence,
      incomingSelectionMetadata.content_evidence
    )
  };
